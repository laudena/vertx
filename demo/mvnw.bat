...
:checkMBat
@REM if exist "%M2_HOME%\bin\mvn.bat" goto init

@REM echo.
@REM echo ERROR: M2_HOME is set to an invalid directory.
@REM echo M2_HOME = "%M2_HOME%"
@REM echo Please set the M2_HOME variable in your environment to match the
@REM echo location of the Maven installation
@REM echo.
@REM goto error
@REM ==== END VALIDATION ====
